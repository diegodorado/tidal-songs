...
void main() {
  ...
  float x = smoothstep(0.4, 0.9, sin(t*0.1)*0.5+0.5);
  ...
  vec4 color1 = vec4(sin(t)*0.3+0.5,sin(t2)*0.3+0.5,sin(t3)*0.3+0.5,0.5)*(f0-f1)*8.;;
  vec4 color2 = vec4(0.1, 0.1,0.2, 0.2)*(f1-f0*0.35)*3.;
