...
let p = streamReplace tidal
    ...
    m0 = p 10 . (|< orbit 0). (# midi 0)
    m1 = p 11 . (|< orbit 0). (# midi 1)
    m2 = p 12 . (|< orbit 0). (# midi 2)
    c0 n v = p 20 . (|< orbit 0). (# cc 0 n  v)
    c1 n v = p 21 . (|< orbit 0). (# cc 1 n  v)
    c2 n v = p 22 . (|< orbit 0). (# cc 2 n  v)
